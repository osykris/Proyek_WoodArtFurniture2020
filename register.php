...
<body>
    ...
    <img src="asset/form_regis_login.png" class="card-img-top" alt="...">
    <a class="login" href="login.php">Log in</a>
    <a href="register.php">Sign up</a>
    <hr>
    <form method="post" action="regissuccess.php">
        ...
        <div class="form-group">
            <label for="passcode"  class="col-md-2 col-form-label text-md-right">Passcode</label>
            <div class="col-md-6">
